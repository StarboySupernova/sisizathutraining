...
<style>
    ...
    .glow-orb-3 {
        ...
        max-width: 700px;
        max-height: 700px;
        background: rgba(67, 22, 219, 0.15);
        filter: blur(150px);
        bottom: 10%;
        left: 10%;
    }
    ...
    .sisi-title span {
        ...
        filter: drop-shadow(0 0 15px rgba(243, 112, 33, 0.3));
    }
    ...
    .sisi-btn {
        ...
        color: var(--svg-dark-blue) !important;
        border: none;
    ...
    .sisi-btn:hover {
        ...
        box-shadow: 0 20px 40px rgba(243, 112, 33, 0.5);
        color: var(--primary) !important;
    }

    .sisi-btn svg {
        fill: var(--svg-dark-blue);
    ...
    .stack-1 {
        ...
        background: linear-gradient(135deg, rgba(67, 22, 219, 0.85), rgba(0, 207, 253, 0.4));
    }

    .stack-2 {
        z-index: 4;
        transform: translate(20px, -5px) scale(0.95) rotate(2deg);
        background: linear-gradient(135deg, rgba(243, 112, 33, 0.8), rgba(212, 93, 26, 0.5));
    }

    .stack-3 {
        z-index: 3;
        transform: translate(80px, -30px) scale(0.9) rotate(6deg);
        background: linear-gradient(135deg, rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.02));
    }

    .card-stack-container:hover .stack-1 {
        transform: translate(0, 0) rotate(0);
        z-index: 3;
    }

    .card-stack-container:hover .stack-2 {
        transform: translate(20px, -20px) scale(0.95) rotate(0);
        opacity: 0.95;
        z-index: 2;
    }

    .card-stack-container:hover .stack-3 {
        transform: translate(40px, -40px) scale(0.9) rotate(0);
    ...
    .stat-box h3 {
        ...
        margin: 0;
        line-height: 1;
        text-shadow: 0 4px 10px rgba(243, 112, 33, 0.4);
    }
    ...
    .glass-card:hover .glass-icon-3d {
    ...
    .cta-banner {
        ...
        position: relative;
        overflow: hidden;
        box-shadow: 0 30px 60px rgba(243, 112, 33, 0.4);
    }
    ...
    /* ========================================================== */
    .sisi-moodle-dynamic-content {
        position: relative;
        z-index: 10;
        padding-bottom: 2rem;
    }

    .sisi-moodle-dynamic-content h2 {
        font-family: 'Poppins', sans-serif;
    ...
    .sisi-moodle-dynamic-content .coursename a {
        color: white;
        text-decoration: none;
        font-size: 1.5rem;
        font-family: 'Poppins', sans-serif;
    ...
    .sisi-moodle-dynamic-content .coursename a:hover {
        color: var(--primary);
    }

    .sisi-moodle-dynamic-content .frontpage-category-names {
        display: flex;
        flex-wrap: wrap;
        gap: 15px;
        justify-content: center;
    ...
    .sisi-moodle-dynamic-content .categorybox:hover {
        background: var(--primary);
        border-color: var(--primary);
        transform: translateY(-3px);
    }

    .sisi-moodle-dynamic-content .categorybox a {
        color: white;
        font-weight: 700;
        text-decoration: none;
        font-size: 1.1rem;
    ...
    @media (max-width: 850px) {
        ...
        .stack-3 {
            transform: translate(25px, -20px) scale(0.9) rotate(5deg);
        }
   ...
   /* ========================================================== */
    /* 10. ENROLLMENT SECTION (CAROUSEL & FORM)                   */
    /* ========================================================== */
    .sisi-enrollment-section {
        display: flex; align-items: center; gap: 4rem; padding: 6rem 0 2rem 0; flex-wrap: wrap; position: relative; z-index: 10; justify-content: center;
    }
    .sisi-enrollment-section > div { flex: 1 1 400px; max-width: 500px; }

    /* SVG Carousel Animation */
    .svg-carousel-container { width: 100%; max-width: 420px; margin: 0 auto; position: relative; animation: floatCard 6s ease-in-out infinite; }
    @keyframes floatCard { 0% { transform: translateY(0px) rotate(0deg); } 50% { transform: translateY(-12px) rotate(1deg); } 100% { transform: translateY(0px) rotate(0deg); } }
    .carousel-mask { width: 100%; height: 100%; border-radius: 26px; overflow: hidden; position: relative; background: #11173b; }
    .carousel-image { position: absolute; inset: 0; opacity: 0; transform: translateX(60px) scale(0.8) rotate(-4deg); transition: all 0.9s cubic-bezier(0.34, 1.56, 0.64, 1); z-index: 1; }
    .carousel-image.active { opacity: 1; transform: translateX(0px) scale(1) rotate(0deg); z-index: 2; }
    .glass-reflection-overlay { position: absolute; inset: 0; background: linear-gradient(135deg, rgba(255, 255, 255, 0.12) 0%, rgba(255, 255, 255, 0) 50%); border: 1.5px solid rgba(243, 112, 33, 0.5); border-radius: 26px; pointer-events: none; z-index: 3; box-shadow: inset 0 0 25px rgba(0, 0, 0, 0.6); }
    
    /* Glassmorphism Quote Form */
    .quote-form-container { background: rgba(20, 20, 30, 0.6); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px); padding: 40px; border-radius: 20px; border: 1px solid rgba(255, 255, 255, 0.15); border-top: 1px solid rgba(243, 112, 33, 0.4); box-shadow: 0 30px 60px rgba(0, 0, 0, 0.6); }
    .quote-form-container h3 { font-size: 2.2rem; margin-bottom: 20px; color: #fff; font-family: 'Poppins', sans-serif; }
    .quote-form-container input, .quote-form-container textarea { width: 100%; padding: 14px 15px; margin-bottom: 15px; border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; background: rgba(0, 0, 0, 0.4); color: #fff; font-size: 1rem; outline: none; transition: 0.3s; }
    .quote-form-container input:focus, .quote-form-container textarea:focus { border-color: #F37021; box-shadow: 0 0 15px rgba(243, 112, 33, 0.3); }
    
    /* Custom Dropdown */
    .sisi-custom-select { position: relative; margin-bottom: 15px; cursor: pointer; }
    .sisi-select-trigger { display: flex; justify-content: space-between; align-items: center; padding: 14px 15px; background: rgba(0, 0, 0, 0.4); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: #fff; transition: 0.3s; }
    .sisi-select-trigger.active { border-color: #F37021; box-shadow: 0 0 15px rgba(243, 112, 33, 0.3); }
    .sisi-select-menu { position: absolute; top: calc(100% + 8px); left: 0; width: 100%; background: rgba(20, 20, 30, 0.95); backdrop-filter: blur(20px); border: 1px solid #F37021; border-radius: 12px; z-index: 100; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.8); display: none; }
    ...
    /* Buttons */
    .submit-btn { width: 100%; background: #F37021; color: #fff; padding: 16px; border: none; border-radius: 8px; font-weight: 800; cursor: pointer; transition: 0.3s; }
...
<div id="sisi-modern-wrapper">
    ...
    <div class="sisi-container">
        ...
        <!-- 1. HERO SECTION (RESTORED 3D STACK) -->
        <div class="sisi-hero">
            <div class="sisi-hero-text">
                ...
                <div class="sisi-btn-group">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo $CFG->wwwroot; ?>/gamified_journey.php" class="sisi-btn sisi-btn-outline">
                        🕹️ Start Gamified Journey
                    </a>
                </div>
            </div>
            ...
            <div class="card-stack-container">
                <div class="stacked-card stack-3">
                    <h4><img src="https://cdn.jsdelivr.net/gh/microsoft/fluentui-emoji@latest/assets/Fire/3D/fire_3d.png" class="icon-3d-sm" alt="Fire"> Instant Feedback</h4>
                    <div class="faux-line w-80"></div>
                </div>
                <div class="stacked-card stack-2">
                    <h4><img src="https://cdn.jsdelivr.net/gh/microsoft/fluentui-emoji@latest/assets/Trophy/3D/trophy_3d.png" class="icon-3d-sm" alt="Trophy"> Gamified Leaderboards</h4>
                    <div class="faux-line w-60"></div>
                    <div class="faux-line w-40"></div>
                </div>
                <div class="stacked-card stack-1">
                    <h3><img src="https://cdn.jsdelivr.net/gh/microsoft/fluentui-emoji@latest/assets/Rocket/3D/rocket_3d.png" class="icon-3d" alt="Rocket"> Fast-Track Certification</h3>
                    <div class="faux-line w-80"></div>
                    <h4><img src="https://cdn.jsdelivr.net/gh/microsoft/fluentui-emoji@latest/assets/Trophy/3D/trophy_3d.png" class="icon-3d-sm" alt="Trophy"> Gamified Quizzes</h4>
                    <div class="faux-line w-60"></div>
                    <div class="faux-line w-40"></div>
                </div>
            </div>
        ...
        <!-- 1.5. ENROLLMENT SECTION (CAROUSEL & FORM) -->
        <div class="sisi-enrollment-section">
            <!-- Left Side: SVG Carousel -->
                    ...
                    <svg width="100%" viewBox="0 0 310 432" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_sisi" x1="9.29688" y1="0.958984" x2="-32.3731" y2="353.027" gradientUnits="userSpaceOnUse">
                                ...
                                <stop offset="1" stopColor="#D45D1A" />
                            </linearGradient>
                        </defs>
                    </svg>
                </div>
        ...
        <div class="sisi-moodle-dynamic-content" id="coursesearch">
            ...
            <style>
                ...
                .drawer .list-group-item a {
                    color: #CBD5E1 !important;
                }

                .drawer .list-group-item a:hover {
                    color: #ffffff !important;
